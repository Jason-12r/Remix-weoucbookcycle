...
import { books, users, BookItem, User } from '../data/mockData';
    ...
    return (
      <div className="flex flex-col h-full bg-slate-950 p-6 items-center justify-center text-center">
        ...
        <p className="text-slate-400 mb-8 max-w-xs">
          Your Trust Score has dropped to {user.trustScore}. You are currently banned from posting new listings.
        </p>
        <button 
          onClick={onBack}
      ...
      <div className="flex-1 overflow-y-auto px-4 py-6 relative z-10">
        ...
        <section className="mb-8">
          ...
          <div className="space-y-4 mb-6">
            <div>
              <label className="text-sm text-slate-400 font-medium ml-1 mb-2 block">Book Title</label>
              <input 
                type="text" 
                value={title}
            ...
            <div>
              <label className="text-sm text-slate-400 font-medium ml-1 mb-2 block">Author</label>
              <input 
                type="text" 
                value={author}
          ...
          <div className="space-y-4">
            <h3 className="text-sm text-slate-400 font-medium ml-1">Categories & Tags</h3>
